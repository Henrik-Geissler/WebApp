...
When('I open the page {string-env}', async function(page) {
...
When('I open the page {string-env} with user agent {string}', async function(
  page,
  userAgent,
) {
  const url = ''.concat(host, page)
...
When('I open the page {string-env} with device {string}', async function(
  page,
  device,
) {
  const url = ''.concat(host, page)
...
When('I delete the cookie {string-env}', deleteCookie)
...
When('I scroll to the element {string}', scrollToElement)
...
When('I set the file element {string} value to {string-env}', fileUpload)

When('I set the element {string} style {string} to {string}', setElementStyle)
